...
sudo apt-get install -y curl wget git net-tools unzip
...
### Fix ssh service failed
ssh-keygen -A
sudo systemctl restart sshd

### Add public key mc
echo 'Adding pub key to authorized'
echo 'ssh-rsa  mc@mc' >> /home/mc/.ssh/authorized_keys
